...
// add ou edit produit
export function Produit({ product }: { product?: IProduct }) {
    ...
    return (
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
                <Button variant="secondary">{product ? "Edit Product" : "Ajouter"}</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>{product ? "Edit Product" : "Add Product"}</DialogTitle>
                    <DialogDescription>
                        {product ? "Make changes to your product here. Click save when you're done." : "Add a new product here. Click save when you're done."}
                    </DialogDescription>
                </DialogHeader>
